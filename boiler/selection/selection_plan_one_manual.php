<?php
/**
 * 手动选型 选型方案一 selection_plan_one_manual.php
 *
 * @version       v0.01
...
<body class="body_2">
      ...
      <div class="manageHRWJCont_middle_middle" >
          <div id="step" style="margin-top: 30px">
              <div class="step-wrap">
                  <div class="step-list">
                      <div class="step-num">
                          <div class="num-bg"><a href="selection_manual_new.php?id=<?php echo $id ?>" class="num-bg">1</a></div>
                      </div>
                      <span class="step-name"><a href="selection_manual_new.php?id=<?php echo $id ?>" class="step-name">选型</a></span>

                  </div>
                  <div class="step-line"></div>
                  <div class="step-list">
                      <div class="step-num">
                          <div class="num-bg">2</div>
                      </div>
      ...
      <div style="margin-top: 20px;">
                    ...
                    if (!empty($guolus)) {
                        foreach ($guolus as $guolu) {
                            ...
                            <tr class="guolu">
                                ...
                                <td class="center" id="guolu_vender"
                                    data-value="<?php echo $guoluinfo['vender']; ?>"><?php echo $vendername ?></td>
                                <td class="center" id="guolu_version"
                                    data-value="<?php echo $version; ?>"><?php echo $version ?></td>
                                <td class="center" id="guolu_num"
                                    data-value="<?php echo $guolu_num; ?>"><?php echo $guolu_num; ?>
                                </td>
                                <td class="center" id="guolu_context"
                                    data-value="<?php echo $guolu["guolu_context"]; ?>"><?php echo $guolu["guolu_context"]; ?></td>
                                <td><input type="radio" name="price_guolu_<?php echo $guoluinfo["proid"] ?>"
                                           value="<?php echo $guolu_maxprice; ?>"
                                           class="inputing"/><?php echo $guolu_maxprice; ?></td>
                                <td><input type="radio" name="price_guolu_<?php echo $guoluinfo["proid"] ?>"
                                           value="<?php echo $guolu_minprice; ?>"
                                           class="inputing"/><?php echo $guolu_minprice; ?></td>
                                <td><input type="radio" name="price_guolu_<?php echo $guoluinfo["proid"] ?>"
                                           value="<?php echo $guolu_avgprice; ?>"
                                           class="inputing"/><?php echo $guolu_avgprice; ?></td>
                                <td><input type="radio" name="price_guolu_<?php echo $guoluinfo["proid"] ?>"
                                           value="<?php echo $guolu_newprice; ?>"
                                           class="inputing"/><?php echo $guolu_newprice; ?></td>
                                <td class="defined" style="width:35px;">
                                    <input type="number" name="textprice" id="guolu_add_price" value=""
                                           class="price_input" style="max-width:55%;"/>
                                    <input type="hidden" name="choose_guolu_price" id="choose_guolu_price" value=""/>
                                    <input type="hidden" name="attrid" id="attrid"
                                           value="<?php echo $guoluinfo["proid"]; ?>"/>
          ...
          <div class="footer" style="margin: 0 auto 99px auto;display: flex;justify-content: space-around;padding-top: 90px;">
              <button class="GLXXmain_17" type="button"  id="btn_submit_ahead" value="上一步"
                      style="width: 25%;height:auto;margin-left: 0 !important;margin-top: 3%;">
      ...
      <script>
          ...
          //               '<option value="0">暂无可选型号</option>' + guolu_version_html +
          //           '</select>'+
          //       '</td>'+
          //       '<td class="center">'+
          ...
          $('#btn_submit_next').on('click',function () {
              ...
              for (var i = 0; i < guoluArr.length; i++) {
                  ...
                  if (guolu_currentNum == null || guolu_currentNum == "" || guolu_currentNum < 1){
                      layer.alert("请输入合适的锅炉数量！",{icon:5});
                      return false;
                  }
          ...
          $(document).on('change','.guolu_vender',function(){
              ...
              if(vender != 0) {
                  var select_length = 0;
                  select_length = <?php echo count($guolu_ids) ?>;
                      ...
                      success: function (data) {
                          ...
                          switch (code) {
                              case 1:
                                  ...
                                  var mid = (guoluItem["guoluinfo"]['id'] == null) ? 0 : parseInt(guoluItem["guoluinfo"]['id']);
                                  ...
                                  var addInputFourHtml = "<input type=\"hidden\" name=\"textprice\" value =\"" + mid + "\" id=\"gid\" />";
