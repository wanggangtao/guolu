<?php
/**
 * 选型方案一修改页面 selection_plan_one_update.php
 *
 * @version       v0.01
...
//$heat_fujiplan=Selection_plan::getInfoByHidandTabtypeandAttrid($id,1,13606);
//
//$heat_planprice=$heat_fujiplan[0]['pro_price'];
//print_r($heat_planprice);
...
<div class="manageHRWJCont_middle_middle">
    ...
    <div id="step" style="margin-top: 30px">
        <div class="step-wrap" align="center">
            ...
            <div class="step-line"></div>
            <?php if($info['status'] == 5){//从方案池过来查看页面
                ?>
            <div class="step-list">
                <div class="step-num">
                    <?php
                        $front_plan=Selection_plan_front::getInfoByHistoryId($id);
                        if($front_plan){
                            $front_plan_id=$front_plan['id']?$front_plan['id']:'';
                        }
                    ?>
                    <div class="num-bg"><a href="selection_plan_two.php?id=<?php echo $id; ?>&&front_plan_id=<?php echo $front_plan_id; ?>" style="color: white">3</a>
                    </div>
                </div>
                ...
                while ($current_guolu_length < count($guolu_plan_items)){
                    ...
                    <tr class="guolu">
                        ...
                        <td class="defined guolu_addprice" style="width:35px;">
                            ...
                            <input type="hidden" name="choose_guolu_price" id="choose_guolu_price" value=""/>
                            <input type="hidden" name="attrid" id="attrid" value="<?php echo $guolu_plan_items[$current_guolu_length]['attrid']; ?>"/>
                        </td>
                    </tr>
                    <?php
                    $current_guolu_length++;
        ...
        <div class="GLXX1_main3" ><!--采暖辅机-->
            ...
            <table style="position:relative;">
                ...
                foreach ($heat_fujilist as $item){
                    ...
                    $heat_fujiplan=Selection_plan::getInfoByHidandTabtypeandAttrid($id,1,$item['id']);
                    $heat_planprice=$heat_fujiplan[0]['pro_price'];
...
//                                        }
                                    ...
                                    $heat_planprice=$heat_fujiplan?$heat_fujiplan[0]['pro_price']:0;
...
//                                        echo '<td>' . $vendername . '</td>';
                                    ...
                                    echo '<td class="defined">
    					                        <input type="number" name = "textprice" id="heat_add_price" value="'.$heat_planprice.'" class="price_input"  style="max-width:55%;"/>
                ...
                <tr class="heat_addtr"  style="display: none">
                    <td >
                        <input style="margin:2px" class="GLXXmain_3" type="text" value="" id="heat_addname"/>
                    </td>
                    <td >
                        <input style="margin:2px" class="GLXXmain_3" type="text" value="" id="heat_addversion"/>
                    </td>
                    <td >
                        <input style="margin:2px" class="GLXXmain_3" type="number" value="" id="heat_addnum"/>
                    </td>
                    <td >
                        <input style="margin:2px" class="GLXXmain_3" type="text" value="" id="heat_addcontext"/>
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td class="defined">
                        <input type="number" name="heat_addprice" id="heat_addprice" value="" class="addprice_input"  style="max-width:55%;" />
                        <span   style="color: red" class="mouheat" id="delete_addheat" />删除</span>
                    </td>
                </tr>
                <!-------显示自定义采暖辅机表单------->
                <?php
                $heat_planinfo=Selection_plan::getListByHidandTabtype($id,1);
                foreach($heat_planinfo as $heat_planvalue) {
                    if ($heat_planvalue["equ_name"]) {
                        ?>
                        <tr class="heat_item">
                            <td>
                                <input style="margin:2px" class="GLXXmain_3" type="text" value="<?php echo $heat_planvalue["equ_name"];?>" id="heat_name"/>
                            </td>
                            <td>
                                <input style="margin:2px" class="GLXXmain_3" type="text" value="<?php echo $heat_planvalue["version"];?>" id="heat_version"/>
                            </td>
                            <td>
                                <input style="margin:2px" class="GLXXmain_3" type="number" value="<?php echo $heat_planvalue["nums"];?>" id="heat_num"/>
                            </td>
                            <td>
                                <input style="margin:2px" class="GLXXmain_3" type="text" value="<?php echo $heat_planvalue["remark"];?>" id="heat_context"/>
                            </td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td class="defined">
                                <input type="number" name="heat_price" id="heat_price" value="<?php echo $heat_planvalue["pro_price"];?>" class="price_input"
                                       style="max-width:55%;"/>
        ...
        <div class="GLXX1_main4" ><!--辅机-->
            ...
            <table style="position:relative;">
                ...
                foreach ($water_fujilist as $item){
                    $water_fujiplan=Selection_plan::getInfoByHidandTabtypeandAttrid($id,2,$item['id']);
                    $water_planprice=$water_fujiplan?$water_fujiplan[0]['pro_price']:0;
...
//                                            }
                                    ...
                                    echo '<td><input type="radio" name="price_fuji_'.$item["id"].'" value="' . $before_price . '" class="inputing"/>' . $before_price . '</td>';
                                    echo '<td class="defined">
    					                        <input type="number" name = "textprice" id="water_add_price" value="'.$water_planprice.'" class="price_input"  style="max-width:55%;" />
                ...
                <tr class="water_addtr"  style="display: none">
                    <td >
                        <input style="margin:2px" class="GLXXmain_3" type="text" value="" id="water_addname"/>
                    </td>
                    <td >
                        <input style="margin:2px" class="GLXXmain_3" type="text" value="" id="water_addversion"/>
                    </td>
                    <td >
                        <input style="margin:2px" class="GLXXmain_3" type="number" value="" id="water_addnum"/>
                    </td>
                    <td >
                        <input style="margin:2px" class="GLXXmain_3" type="text" value="" id="water_addcontext"/>
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td class="defined">
                        <input type="number" name="water_addprice" id="water_addprice" value="" class="addprice_input"  style="max-width:55%;" />
                        <span   style="color: red" class="mouwater" id="delete_addwater" />删除</span>
                    </td>
                </tr>
                <!-------显示的自定义热水辅机表单------->
                <?php
                $water_planinfo=Selection_plan::getListByHidandTabtype($id,2);
                foreach($water_planinfo as $water_planvalue) {
                    if ($water_planvalue["equ_name"]) {
                        ?>
                        <tr class="water_item" >
                            <td>
                                <input style="margin:2px" class="GLXXmain_3" type="text" value="<?php echo $water_planvalue["equ_name"];?>" id="water_name"/>
                            </td>
                            <td>
                                <input style="margin:2px" class="GLXXmain_3" type="text" value="<?php echo $water_planvalue["version"];?>" id="water_version"/>
                            </td>
                            <td>
                                <input style="margin:2px" class="GLXXmain_3" type="number" value="<?php echo $water_planvalue["nums"];?>" id="water_num"/>
                            </td>
                            <td>
                                <input style="margin:2px" class="GLXXmain_3" type="text" value="<?php echo $water_planvalue["remark"];?>" id="water_context"/>
                            </td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td class="defined">
                                <input type="number" name="water_price" id="water_price" value="<?php echo $water_planvalue["pro_price"];?>" class="price_input"
                                       style="max-width:55%;"/>
        ...
        <table style="position:relative;" >
            ...
            <tr class="other_addtr"  style="display: none">
                ...
                <td>
                    ...
                    <span   style="color: red" class="mou_other" id="delete_other" />删除</span>
                </td>
            </tr>
            <?php
            ...
            if(!empty($rows) ) {
                foreach ($rows as $row) {
                    $other_plan=Selection_plan::getInfoByHidandTabtypeandAttrid($id,3,$row["id"]);
                    $other_planprice=$other_plan?$other_plan[0]['pro_price']:0;
    ...
    <div class="footer" style="margin: 0 auto 99px auto;display: flex;justify-content: space-around;padding-top: 90px;">
        ...
        <button class="GLXXmain_17" type="button"  id="btn_submit_next" value="下一步">下一步</button>
    </div><!--下一步-->
</div>
...
<script>
    ...
    $(document).on('click', '.mougl', function () {
        ...
        $(this).parent().parent().find('.guolu_item:nth-last-child(1)').remove();
        if (len >= 1) {
    ...
    $('.addhfj').click(function () {
        ...
        var NHtml = '<tr  class="heat_additem">' + newht + '</tr>';
        var heat_length=$(".heat_item").length;
        var heat_addlen=$(".heat_additem").length;

        if(heat_length > 0) {
            $(this).parent().parent().find('.heat_item:nth-last-child(1)').after(NHtml);
        }
        if(heat_addlen>0){
            $(this).parent().parent().find('.heat_additem:nth-last-child(1)').after(NHtml);
        }else{
    ...
    $('.addwfj').click(function () {
        ...
        var NHtml = '<tr  class="water_additem">' + newht + '</tr>';
        var water_length=$(".water_item").length;
        var water_addlen=$(".water_additem").length;
        if(water_length > 0) {
            $(this).parent().parent().find('.water_item:nth-last-child(1)').after(NHtml);
        }
        if(water_addlen > 0){
            $(this).parent().parent().find('.water_additem:nth-last-child(1)').after(NHtml);
        }else{
    ...
    $('#btn_submit_next').on('click', function () {
        ...
        if(heat_len > 0) {
            for(var i=0;i < heat_len;i++){
                ...
                var heat_add_currentVal=heat_addName+"-"+heat_addVersion+"-"+heat_addNum+"-"+heat_currentContext+"-"+heat_addPrice;
        ...
        var heat_newArr=$(".heat_additem");
        var hfj_newlen=heat_newArr.length;
        var heat_new_dataArr=[];
        var heat_newStr="";

        if(hfj_newlen > 0) {
               for(var i=0;i < hfj_newlen;i++){
                   var heat_newcurrentDom = heat_newArr[i];
                   var heat_newcurrentName = $(heat_newcurrentDom).find("#heat_addname").val();
                   var heat_newcurrentVersion = $(heat_newcurrentDom).find("#heat_addversion").val();
                   var heat_newcurrentNum = $(heat_newcurrentDom).find("#heat_addnum").val();
                   var heat_newcurrentContext = $(heat_newcurrentDom).find("#heat_addcontext").val();
                   var heat_newcurrentPrice = $(heat_newcurrentDom).find("#heat_addprice").val();

                   if(heat_newcurrentName !=  "" && heat_newcurrentName !=  null ){
                       var heat_newName=heat_newcurrentName;
                   }else{
                       layer.alert("请填写采暖辅机名称！", {icon: 5});
                       return false;
                   }
                   if(heat_newcurrentVersion != "" && heat_newcurrentVersion != null){
                       var heat_newVersion=heat_newcurrentVersion;
                   }else{
                       layer.alert("请填写采暖辅机型号！", {icon: 5});
                       return false;
                   }
                   if(heat_newcurrentNum != "" && parseFloat(heat_newcurrentNum) > 0 ){
                       var heat_newNum=heat_newcurrentNum;
                   }else{
                       layer.alert("请填写采暖辅机数量！", {icon: 5});
                       return false;
                   }
                   if(heat_newcurrentPrice != ""){
                       if(heat_newcurrentPrice >= 0){
                           var heat_newPrice=heat_newcurrentPrice;
                       }else{
                           layer.alert("采暖辅机价格不能小于0！", {icon: 5});
                           return false;
                       }
                   ...
                   var heat_new_currentVal=heat_newName+"-"+heat_newVersion+"-"+heat_newNum
                       +"-"+heat_newcurrentContext +"-"+heat_newPrice;
                   heat_new_dataArr.push(heat_new_currentVal);
               }
            heat_newStr = heat_new_dataArr.join("#");
        }
        ...
        //热水辅机添加参数
        var water_newArr=$(".water_additem");
        var wfj_newlen=water_newArr.length;

        var water_new_dataArr=[];
        var water_newStr="";
        if(wfj_newlen > 0) {
            for(var i=0;i < wfj_newlen;i++) {
                var water_newcurrentDom = water_newArr[i];

                var water_newcurrentName = $(water_newcurrentDom).find("#water_addname").val();

                var water_newcurrentVersion = $(water_newcurrentDom).find("#water_addversion").val();
                var water_newcurrentNum = $(water_newcurrentDom).find("#water_addnum").val();

                var water_newcurrentContext = $(water_newcurrentDom).find("#water_addcontext").val();
                var water_newcurrentPrice = $(water_newcurrentDom).find("#water_addprice").val();


                if (water_newcurrentName != "" && water_newcurrentName != null) {
                    var water_newName = water_newcurrentName;
                ...
                if (water_newcurrentVersion != "" && water_newcurrentVersion != null) {
                    var water_newVersion = water_newcurrentVersion;
                } else {
                    layer.alert("请填写热水辅机型号！", {icon: 5});
                    return false;
                }
                if (water_newcurrentNum != "" && parseFloat(water_newcurrentNum) > 0) {
                    var water_newNum = water_newcurrentNum;
                } else {
                    layer.alert("请填写热水辅机数量！", {icon: 5});
                    return false;
                }
                if (water_newcurrentPrice != ""){
                    if(water_newcurrentPrice >= 0){
                        var water_newPrice = water_newcurrentPrice;
                    }else{
                        layer.alert("热水辅机价格不能小于0！", {icon: 5});
                        return false;
                    }
                ...
                var water_new_currentVal = water_newName + "-" + water_newVersion
                    + "-" + water_newNum + "-" + water_newcurrentContext + "-" + water_newPrice;

                water_new_dataArr.push(water_new_currentVal);

            }
            water_newStr = water_new_dataArr.join("#");
        }
        // return false;
        //------------------------------之前选择的设备报价-------------------------------------
        ...
        for (var i = 0; i < guoluArr.length; i++) {
            ...
            var guolu_attrId = $(guolu_currentDom).find("#attrid").val();//获取每一行的id
            ...
            var guolu_currentStr = guolu_currentNum + "||" + guolu_currentContext + "||"
        ...
        if (fuji_sel_Arr.length > 0) {//页面出现辅机表单
            for (var i = 0; i < fuji_sel_Arr.length; i++) {
                ...
                var fuji_sel_currentId = $(fuji_sel_currentDom).find("#hid").val();//获取每一行的selection_id
                var fuji_sel_currentPId = $(fuji_sel_currentDom).find("#hmid").val();//获取每一行的pro_id

                var fuji_sel_currentStr = fuji_sel_currentId + "-" + fuji_sel_currentVal + "-" + fuji_sel_currentPId;
                //将每一行的id和价格以及文本框中的价格拼接成字符串
        ...
        if (fuji_text_Arr.length > 0) {
            for (var i = 0; i < fuji_text_Arr.length; i++) {
                ...
                var fuji_text_currentId = $(fuji_text_currentDom).find("#hid").val();//获取每一行的id
        ...
        if (water_sel_Arr.length > 0) {
            for (var i = 0; i < water_sel_Arr.length; i++) {
                ...
                var water_sel_currentPId = $(water_sel_currentDom).find("#wmid").val();//获取每一行的pro_id

                var water_sel_currentStr = water_sel_currentId + "-" + water_sel_currentVal + "-" + water_sel_currentPId;
                //将每一行的id和价格以及文本框中的价格拼接成字符串
        ...
        if (water_text_Arr.length > 0) {
            for (var i = 0; i < water_text_Arr.length; i++) {
                ...
                var water_text_currentId = $(water_text_currentDom).find("#wid").val();//获取每一行的id
        ...
        if (otherArr.length > 0) {
            for (var i = 0; i < otherArr.length; i++) {
                ...
                if (i < other_origin_length) {
                    ...
                    if (other_new_currentPrice != ""){
                        if(other_new_currentPrice > 0){
        ...
        $.ajax({
            ...
            data        : {
                ...
                heat_newStr:heat_newStr,
                water_newStr:water_newStr,
            ...
            dataType :    'json',
            url :         'selection_plan_one_do.php?act=updateprice',
    ...
    $(document).on('change','.guolu_vender',function(){
        ...
        if(vender != 0){
            ...
            select_version_length = <?php echo count($origin_guolu_list_length) ?>;
    ...
    function getGuoluPrice(my_guolu_id,mMaxPriceDom,mMinPriceDom,mAvgPriceDom,mNewPriceDom,mAddPriceDom) {
        ...
        for(var i = 0; i < guoluArr.length; i++){
            var guolu_currentDom = guoluArr[i];
            var guoluId = $(guolu_currentDom).find("#guolu_version").val();// 获取每一行的锅炉id
            if(guoluId == guolu_id){
                count++;
            }
        }
            ...
            success: function (data) {
                ...
                switch (code) {
                    case 1:
                        ...
                        var attrid = (guoluItem["guoluinfo"]['id'] == null)?0:parseInt(guoluItem["guoluinfo"]['id']);
                        ...
                        var addInputFourHtml = "<input type=\"hidden\" name=\"textprice\" value =\"" + attrid + "\" id=\"attrid\" />" ;
