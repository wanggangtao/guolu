...
$message_count = Message_info::getPageList(1, 10, 0, $USERId, 0, '');
$message_list = Message_info::getPageList($page, $pageSize, 1, $USERId, 0, '');
...
<div class="indexTop_all">
    ...
    ?>
        ...
        <div class="message_1">
            <table>
                <?php
                foreach ($message_list as $thismsg){$openstr = '';
                ...
                layui.use('laypage', function(){
                    ...
                    laypage.render({
                        ...
                        ,jump: function(obj, first){
                            ...
                            if(!first){
                                //do something
                                location.href  = "message.php?page="+obj.curr+"&pagesize="+obj.limit;
                            }
                        }
    ...
    <div class="NOmessage_2">暂时没有站内信哦～</div>
    </div>
    <?php
    }
    ?>
