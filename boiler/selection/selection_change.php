...
<body class="body_2">
    ...
    <div class="manageHRWJCont_middle_left" style="margin-top: 30px">
        ...
        <ul>
            ...
            <a href="selection_change.php"><li class="manage_liCheck">更换锅炉</li></a>
            ...
            <div class="step-wrap">
                ...
                <ul class="step">
                    <li class="step-item active">
                        ...
                        <div class="setp-item-title">选型</div>
                    </li>
                    <li class="step-item">
                        <div class="setp-item-num"><span>2</span></div>
                        <div class="setp-item-title">报价</div>
                    </li>
                    <li class="step-item">
                        <div class="setp-item-num"><span>3</span></div>
                        <div class="setp-item-title">方案生成</div>
                    </li>
                </ul>-->
                <div class="step-list">
                    <div class="step-num">
...
<!--        --><?php //if(empty($row)){?>
    <div class="GLXXmain">
        ...
        <div class="GLXXmain_2">
            <input type="text" class="GLXXmain_3" id="customer" value="<?php if(!empty($project_info)) echo $project_info['name'];?>" ><button class="GLXXmain_4" id="resetting" >重置</button>
        </div>
        ...
        <div id="nuanqi" class="GLXXmain_8" style="display: block">
            ...
            <?php
            if(!empty($row)){
            if($row['application']!=1 and $row['heating_type']==3){?>
                ...
                <div class="insertion">
                    ...
                    <div class="GLXXmain_2">
                        <select type="text" class="GLXXmain_3" id="guolu_type_list" style="width: 344px">
                            <?php
                            $guolu_name = Guolu_attr::getInfoById($value)['version'];
                            echo '<option value="'.$value.'">'.$guolu_name.'</option>';
                            ?>
                        </select>
...
<?php }?>
        ...
        <div id="WandN" class="GLXXmain_8" style="display: none">
            ...
            <?php if(!empty($row) and $row['application']!=1 and $row['heating_type']==3){?>
            <div id="heating_dom" style="display: block">
                <div class="GLXXmain_1">采暖形式</div>
                <div class="GLXXmain_2">
                    <select type="text" class="GLXXmain_3 heating_type" id="heating_type" style="width: 344px">
...
<!---->
<!--            <div id="area_dom" style="display: none">-->
<!--                <div class="GLXXmain_1">分区数</div>-->
<!--                <div class="GLXXmain_2">-->
<!--                    <input type="number" class="GLXXmain_3" id="area_num">-->
<!--                </div>-->
<!--            </div>-->
