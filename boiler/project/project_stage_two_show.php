    ...
    <script type="text/javascript">
        $(function(){
            $('#record_two').click(function(){
                location.href = 'project_two_record_show.php?id='+'<?php echo $id;?>'+'&tag='+'<?php echo $tag;?>';
            });
        });
        ...
        <div class="manageHRWJCont_middle">
            ...
            <?php
                ...
                <div class="middleDiv_nine">
                    <div class="middleDiv_nine_left"> <p><img class="must_reactImg" src="<?php echo $thislinkman['isimportant'] == 1?'images/radio_check.png':'images/must_react.png' ?>" alt="">联系人<?php echo $i;?></p></div>
