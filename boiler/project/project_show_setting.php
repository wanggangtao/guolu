    ...
    <div class="manageHRWJCont_middle">
        <div class="manageHRWJCont_middle_left">
            <ul>
                ...
                ?>
                    <li class="manage_liCheck" onclick="setting_five(this)">项目建议</li>
                <?php
                }
                ?>
            </ul>
        ...
        <div class="manageHRWJCont_middle_middle">
            ...
            if($USERINFO['role'] != 4){
            ?>
            <div class="ProjectCheck_setting_contAll ProjectCheck_setting_cont1" <?php if($USERINFO['role'] == 4){echo 'style="display: none"';} ?>>
            ...
            ?>
            <div class="ProjectCheck_setting_contAll ProjectCheck_setting_cont5" <?php if($USERINFO['role'] == 4){echo 'style="display: block"';} ?>>
