<?php
/**
 * 项目考察记录 project_inspectlog_check.php
 *
 * @version       v0.01
...
<body class="body_1">
    ...
    <div class="manageHRWJCont_middle">
        <div class="manageHRWJCont_middle_left manageRecord_left">
            <ul>
                <a href="project_visitlog_show.php?tag=<?php echo $tag;?>&id=<?php echo $id;?>">
                    <li <?php if($TOP_LEFT_NVA == "visitlog") echo 'class="HRWJCont_li"';?>>拜访记录</li>
                </a>
                <a href="project_inspectlog_show.php?tag=<?php echo $tag;?>&id=<?php echo $id;?>">
                    <li <?php if($TOP_LEFT_NVA == "inspectlog") echo 'class="HRWJCont_li"';?>>考察记录</li>
                </a>
                <a href="project_communication_show.php?tag=<?php echo $tag;?>&id=<?php echo $id;?>">
        ...
        layui.use('laypage', function(){
            ...
            laypage.render({
                ...
                ,jump: function(obj, first){
                    ...
                    if(!first){
                        //do something
                        location.href  = "project_inspectlog_check.php?tag=3&target="+"<?php echo $target; ?>"+"&way="+"<?php echo $way; ?>"+"&endday="+"<?php echo $endday; ?>"+"&stday="+"<?php echo $stday; ?>"+"&id="+"<?php echo $id; ?>"+"&page="+obj.curr+"&pagesize="+obj.limit;
                    }
                }
    ...
    <script>
        $(function () {
            ...
            $('.manageRecord_btn2').click(function(){
                ...
                location.href  = "project_inspectlog_show.php?tag=3&target="+target+"&stday="+stday+"&endday="+endday+"&id="+<?php echo $id;?>;
            });
        });
    </script>
</body>
