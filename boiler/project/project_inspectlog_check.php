    ...
    <div class="manageHRWJCont_middle">
        ...
        <div class="manageHRWJCont_middle_middle">
            ...
            <div class="manageRecordTable">
                <table class="manageRecord_table2 manageRecord_table3 ">
        ...
        layui.use('laypage', function(){
            ...
            laypage.render({
                ...
                ,jump: function(obj, first){
                    ...
                    if(!first){
                        //do something
                        location.href  = "project_inspectlog_check.php?tag=2&target="+"<?php echo $target; ?>"+"&way="+"<?php echo $way; ?>"+"&endday="+"<?php echo $endday; ?>"+"&stday="+"<?php echo $stday; ?>"+"&id="+"<?php echo $id; ?>"+"&page="+obj.curr+"&pagesize="+obj.limit;
                    }
                }
    ...
    <script>
        $(function () {
            ...
            $('.manageRecord_btn2').click(function(){
                ...
                location.href  = "project_inspectlog_check.php?tag=2&target="+target+"&stday="+stday+"&endday="+endday+"&id="+<?php echo $id;?>;
            });
        });
    </script>
</body>
