...
if(!empty($id)) {
    ...
    $project_three_count = Project_three_record::getPageList(1, 10, 0, $id);
    $project_three_list = Project_three_record::getPageList(1, $project_three_count, 1, $id);
        ...
        $(function(){
            $('.detail').click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['600px', '500px'],
                    content: 'project_three_record_info.php?id=' + thisid
                });
            });
        });
            ...
            <div class="programRevise">
                ...
                <div class="programRevise_cont">
                    <table>
                        ...
                        <?php
                        if($project_three_list){
                            foreach ($project_three_list as $threer){
                                echo '
                                    <tr>
                                        <td>'.getDateStr($threer['addtime']).'</td>
                                        <td>'.$threer['user_name'].'</td>
                                        <td> <a href="javascript:void(0);return false;" class="detail">查看>></a>
                                            <input type="hidden" id="aid" value="'.$threer['id'].'"/>
                                        </td>
                                    </tr>';
                            }
                        }
