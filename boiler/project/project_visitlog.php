        ...
        $(function(){
            $('#addvisitlog').click(function(){
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['600px', '600px'],
                    content: 'project_visitlog_add.php?id=' + '<?php echo $id;?>'
                });
            });
            ...
            $('.editinfo').click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['600px', '600px'],
                    content: 'project_visitlog_edit.php?logid=' + thisid
                });
            });
            ...
            $(".delinfo").click(function(){
                ...
                layer.confirm('确认删除该记录吗？', {
                        ...
                        $.ajax({
                            ...
                            dataType : 'json',
                            url : 'project_log_do.php?act=visitdel',
    ...
    <div class="manageHRWJCont_middle">
        ...
        <div class="manageHRWJCont_middle_middle">
            <div class="manageRecord_rightTop">
                <div class="left">
                    <button class="myprogram_button1 manageRecord_btn1" id="addvisitlog">添加</button>
                </div>
                <div class="right">
                    ...
                    <div class="guolumain_4 myprogram_select">
                        <div class="select_1 myprogram_select1"><span id="way" data-dictid="<?php echo $way;?>"><?php echo empty($way)?"全部":$ARRAY_visit_way[$way]; ?></span><img src="images/selectup.png" class="guolumain_4_1"></div>
                       ...
                       foreach ($visitlog_list as $thislog) {
                           ...
                           if(empty($commentlist)){
                               $dostr ='<img class="editinfo" src="images/writing.png" alt="">
                                        <img class="delinfo" src="images/chahao.png" alt="">';
                           }
                           echo '
                                <tr>
        ...
        layui.use('laypage', function(){
            ...
            laypage.render({
                ...
                ,jump: function(obj, first){
                    ...
                    if(!first){
                        //do something
                        location.href  = "project_visitlog.php?tag=1&target="+"<?php echo $target; ?>"+"&way="+"<?php echo $way; ?>"+"&endday="+"<?php echo $endday; ?>"+"&stday="+"<?php echo $stday; ?>"+"&id="+"<?php echo $id; ?>"+"&page="+obj.curr+"&pagesize="+obj.limit;
                    }
                }
    ...
    <script>
        $(function () {
            ...
            $('.manageRecord_btn2').click(function(){
                ...
                location.href  = "project_visitlog.php?tag=1&target="+target+"&stday="+stday+"&endday="+endday+"&way="+way+"&id="+<?php echo $id;?>;
            });
        });
    </script>
</body>
