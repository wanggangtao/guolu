        ...
        layui.use('laypage', function(){
            ...
            laypage.render({
                ...
                ,jump: function(obj, first){
                    ...
                    if(!first){
                        //do something
                        location.href  = "project_visitlog_show.php?tag=3&target="+"<?php echo $target; ?>"+"&way="+"<?php echo $way; ?>"+"&endday="+"<?php echo $endday; ?>"+"&stday="+"<?php echo $stday; ?>"+"&id="+"<?php echo $id; ?>"+"&page="+obj.curr+"&pagesize="+obj.limit;
                    }
                }
    ...
    <script>
        $(function () {
            ...
            $('.manageRecord_btn2').click(function(){
                ...
                location.href  = "project_visitlog_show.php?tag=3&target="+target+"&stday="+stday+"&endday="+endday+"&way="+way+"&id="+<?php echo $id;?>;
            });
        });
    </script>
</body>
