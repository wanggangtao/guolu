    ...
    <script type="text/javascript">
        $(function(){
            $('#record_one').click(function(){
                location.href = 'project_one_record_check.php?id='+'<?php echo $id;?>&tag=2';
            });
            $('#record_same').click(function(){
                location.href = 'project_same_check.php?top_flag=0&id='+'<?php echo $id;?>&tag=2';
            });
    ...
    <div class="manageHRWJCont">
        ...
        <div class="manageHRWJCont_middle">
            ...
            <div class="manageHRWJCont_middle_middle">
                ...
                <div class="middleDiv_nine middleDiv_nine_two">
                ...
                <div class="middleDiv_nine">
                    ...
                    <div class="middleDiv_nine_right">
                        <p><?php echo $project_one['project_linkman']; ?>
                            <!--                            --><?php //if( $samecount5 - 1 > 0) echo '<span class="similar_program">注：已有'.($samecount5 - 1).'个相似项目</span>';?>
                        </p>
                    </div>
                    <div class="clear"></div>
                </div>
                ...
                ?>
                        <div class="middleDiv_nine">
                            <div class="middleDiv_nine_left"><img src="images/must_react.png" alt="">   <p>新换锅炉<?php echo $i;?></p></div>
                            <div class="middleDiv_nine_right">
                                <p><?php echo $thisburner['guolu_tonnage'] ?>  吨</p> <p><?php echo $thisburner['guolu_num'] ?>  台  </p>
                            </div>
                            <div class="clear"></div>
                        </div>
                <?php
