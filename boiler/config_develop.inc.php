...
session_start();
//ob_start();
define("PROJECTCODE",    'boiler');            //项目编号，建议修改，每个项目应该不同
...
//微信推送消息模板
$kf_template_id = "nMue6fGByjZi21MmzRxDIX3Du4cJeHz0Kwb46bqcdK0";

$coupon_template_id = "PgJpFAQfn80Z8JrAaqSxXstoyekxiLsD50nOrjT6C0I";

$kf1_template_id="wQ8P3spv_iMCv9Zteb124OxIFN9HLV7cgChRcnSpoWc";

$kf2_template_id="ghW4Gt7b4vLzXu6pR_HbzrAPhn5uPEDIC3O7RYKv2Ng";

$kf3_template_id="JEbRY_GGFPklEvQmRKsYazC9fB_U0P29sUBXhVr_azQ";
...
$WEIXIN_INFO = array(
    ...
    "mch_id"=>"1236047502",
    "notify_url"=>$HTTP_PATH."pay/weixin_notify.php",
    "pay_key"=>'wiipuxian2015wiipuxian2015wiipux'
