...
$FLAG_LEFTMENU  = 'other_list';
$FLAG_TOPNAV    = 'seletion';

//初始化,$attrid = 6 是菜单“其它”
$page = 1;
$pageSize  = 15;
$totalcount     = Case_tpl::getListByAttrid($attrid = 6, $page, $pageSize, $count = 1);

$pagecount = ceil($totalcount / $pageSize);
$page      = getPage($pagecount);
$rows      = Case_tpl::getListByAttrid($attrid = 6, $page, $pageSize, $count = 0);
        ...
        $(function(){
            ...
            $(".editinfo").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1200px', '630px'],
                    content: 'other_edit.php?id='+thisid
                });
            });
            //详情
            $(".info").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1200px', '600px'],
                    content: 'other_info.php?id='+thisid
                });
            });
            //删除
...
<div id="container">
    ...
    <div id="maincontent">
        <div id="position">当前位置：<a href="other_list.php">选型方案</a> &gt; 其它</div>
        <div id="handlelist">
