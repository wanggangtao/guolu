...
$FLAG_TOPNAV    = "user";
$FLAG_LEFTMENU  = 'department_list';

//初始化
$rows      = User_department::getAllList();
?>
        ...
        $(function(){
            ...
            $(".delete").click(function(){
                ...
                layer.confirm('确认删除该部门吗？', {
                        ...
                        $.ajax({
                            ...
                            dataType : 'json',
                            url : 'user_department_do.php?act=del',
            ...
            $('#add_btn_sumit').click(function(){
                ...
                $.ajax({
                    ...
                    dataType :    'json',
                    url :         'user_department_do.php?act=add',
                    success :     function(data){
                        var code = data.code;
                        var msg  = data.msg;
                        switch(code){
            ...
            $('#edit_btn_sumit').click(function(){
                ...
                $.ajax({
                    ...
                    dataType :    'json',
                    url :         'user_department_do.php?act=edit',
                    success :     function(data){
                        var code = data.code;
                        var msg  = data.msg;
                        switch(code){
...
<div id="container">
    ...
    <div id="maincontent">
        <div id="position">当前位置：<a href="user_list.php">用户管理</a> &gt; 部门</div>
        <div id="handlelist">
