<?php
/**
 * 换热器列表  syswater_exchanger_list.php
 *
 * @version       v0.01
...
//初始化
$count     = Heat_exchanger_attr::getList(1, 15, 1);
$pageSize  = 15;
$pagecount = ceil($count / $pageSize);
$page      = getPage($pagecount);
$rows      = Heat_exchanger_attr::getList($page, $pageSize, 0);
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#search').click(function(){
                ...
                location.href  = "heat_exchanger_list.php?vender="+vender;
            });
            //添加
            $('#add').click(function(){
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['800px', '350px'],
                    content: 'heat_exchanger_add.php'
                });
            });
            //修改
            $(".editinfo").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['800px', '350px'],
                    content: 'heat_exchanger_edit.php?id='+thisid
                });
            });
            //详情
            $(".info").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['800px', '350px'],
                    content: 'heat_exchanger_info.php?id='+thisid
                });
            });
            //删除
            $(".delete").click(function(){
                ...
                layer.confirm('确认删除吗？', {
                        ...
                        $.ajax({
                            ...
                            dataType : 'json',
                            url : 'heat_exchanger_do.php?act=del',
...
<div id="container">
    ...
    <div id="maincontent">
        <div id="position">当前位置：<a href="guolu_list.php">产品中心</a> &gt; 产品管理 &gt; 辅机 &gt; 换热器</div>
        ...
        <div class="tablelist">
            <table>
                ...
                if(!empty($rows)){
                    foreach($rows as $row){
                        $venderInfo = Dict::getInfoById($row['exchanger_vender']);
                        echo '<tr>
                                <td class="center">'.$nums.'</td>
                                <td class="center">'.$row['exchanger_version'].'</td>
                                <td class="center">'.$venderInfo['name'].'</td>
                                <td class="center">'.floatval($row['exchanger_heat_surface']).'</td>
                                <td class="center">
                                    ...
                                    <input type="hidden" id="aid" value="'.$row['exchanger_id'].'"/>
