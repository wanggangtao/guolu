...
<div id="formlist">
    ...
    <p style="<?php echo $id == 1?"display: block;":"display: none;"; ?>">
        <label>厂家logo</label>
    ...
    <p style="padding-left:150px;font-size:14px;<?php echo $id == 1?"display: block;":"display: none;"; ?>" id="val1"></p>

    <p style="<?php echo $id == 1?"display: block;":"display: none;"; ?>">
        <label>类别</label>
        <input type="checkbox" id="cat" value="1"/>工业锅炉
        <input type="checkbox"  value="2"/>壁挂锅炉
    </p>
    <p>
        <label>　　</label>
