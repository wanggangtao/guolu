...
$tabcatid = 3;
//初始化
$count     = Water_box_attr::getList(1, 15, 1);
$pageSize  = 15;
$pagecount = ceil($count / $pageSize);
$page      = getPage($pagecount);
$rows      = Water_box_attr::getList($page, $pageSize, 0);
...
<head>
    ...
    <title>膨胀/软化水箱 - 管件 - 产品管理 - 产品中心 </title>
        ...
        $(function(){
            ...
            $(".editinfo").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['600px', '300px'],
                    content: 'water_box_edit.php?id='+thisid
                });
            });
            //详情
            $(".info").click(function(){
...
<div id="container">
    ...
    <div id="maincontent">
        <div id="position">当前位置：<a href="guolu_list.php">产品中心</a> &gt; 产品管理 &gt; 管件 &gt; 膨胀/软化水箱</div>
                ...
                if(!empty($rows)){
                    foreach($rows as $row){
                        echo '<tr>
                                ...
                                <td class="center">'.$row['box_version'].'</td>
                                <td class="center">'.floatval($row['box_nominal_capacity']).'</td>
                                <td class="center">'.floatval($row['box_available_capacity']).'</td>
                                <td class="center">
                                    ...
                                    <input type="hidden" id="aid" value="'.$row['box_id'].'"/>
