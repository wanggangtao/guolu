...
$id=$_GET['id'];
$product_info=Product_info::getInfoById($id);

$brand=Dict::getListByPid(1,1);
//$type=Dict::getListByParentid(2);
$version=Smallguolu::getList(0,0,$product_info['brand']); //print_r($version);
...
//                $.ajax({
//                    type: 'post',
//                    url: 'weixin_product_do.php?act=edit',
//                    data: {
//                        id:id,
//                        brand: brand,
//                        code:code,
...
<div id="formlist">
    ...
    <p>
        ...
        <input type="text" class="text-input input-length-30" name="code" id="code" value="<?php echo $product_info['code'];?>"/>
        ...
        <select  id="brand" class="select-handle">
            ...
            if($brand)
                ...
                foreach($brand as $thisValue){
                    if($thisValue['id']==$product_info['brand'])
                        echo '<option value="' . $thisValue['id'] . '" '.$select_brand.'>' . $thisValue['name'] . '</option>';
                    else
...
//                    if($thisValue['id']==$product_info['type'])
//                        echo '<option value="' . $thisValue['id'] . '" '.$select_type.'>' . $thisValue['name'] . '</option>';
//                    else
//                        echo '<option value="' . $thisValue['id'] . '">' . $thisValue['name'] . '</option>';
//                }
//            ?>
...
<!--    </p>-->
        ...
        <select  id="version" class="select-handle">
            ...
            if($version)
                ...
                foreach($version as $thisValue){
                    if($thisValue['smallguolu_id']==$product_info['version']){
                        echo '<option value="' . $thisValue['smallguolu_id'] . '" '.$select_version.'>' . $thisValue['smallguolu_version'] . '</option>';
                    }
                    else
                        echo '<option value="' . $thisValue['smallguolu_id'] . '">' . $thisValue['smallguolu_version'] . '</option>';
                }
            ?>
        </select>
    ...
    <p>
        ...
        <br>
        <input type="checkBox" name="outtime" id="outtime" value="过保" <?php if($product_info['period']=="过保") echo "checked"?>/>过保
        <br>
        <input type="text" class="laydate-icon input-length-30"  name="starttime" style="margin-top: 14px" id="starttime" value="<?php if($product_info['period']!="过保") echo date("Y-m-d",$product_info['period'])?>"/>
