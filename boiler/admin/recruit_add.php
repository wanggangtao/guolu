...
<!--    </p>-->
    ...
    <p>
        <label>招聘岗位</label>
        <input type="text" class="text-input input-length-30" name="type" id="type" />
        <span class="warn-inline">* </span>
    </p>
    ...
    <p>
        <label>招聘人数</label>
        <input type="text" class="text-input input-length-30" name="number" id="number"/>
        <span class="warn-inline">* </span>
    </p>
    ...
    <p>
        ...
        <div style="margin-top:40px;margin-left:10%">
            <textarea style="padding:5px;width:60%;height:70px;" name="need" cols=200 id="need" ></textarea>
        </div>
    </p>
