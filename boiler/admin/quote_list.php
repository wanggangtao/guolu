...
$page = 1;
$pageSize  = 15;
$totalcount     = Case_tpl::getListByAttrid($attrid, $page, $pageSize, $count = 1);

$pagecount = ceil($totalcount / $pageSize);
$page      = getPage($pagecount);
$rows      = Case_tpl::getListByAttrid($attrid, $page, $pageSize, $count = 0);
        ...
        $(function(){
            ...
            $(".editinfo").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1200px', '630px'],
                    content: 'quote_edit.php?id='+thisid
                });
            });
            //详情
            $(".info").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1200px', '600px'],
                    content: 'quote_info.php?id='+thisid
                });
            });
...
<div id="container">
    ...
    <div id="maincontent">
        <div id="position">当前位置：<a href="quote_list.php">选型方案</a> &gt;  报价方案</div>
        <div id="handlelist">
            ...
            <table>
                ...
                if(!empty($rows)){
                    foreach($rows as $row){
                        ...
                        ?>
                       <tr>
                                <td class="center"><?php echo $nums;?></td>
                                <td class="center"><?php echo $row['name'];?></td>
                                <td class="center"><?php echo $account;?></td>
                                <td class="center"><?php echo date('Y-m-d H:i:s',$row['lastupdate']);?></td>
                                <td class="center">
                                    <a class="info" href="javascript:void(0)">详情</a> 
                                    <a class="editinfo" href="javascript:void(0)">修改</a>
                                    <a class="delete" href="javascript:void(0)">删除</a>
                                    <a class="price_record" href="pricelog_list.php?type=2&objectid=<?php echo $row['id']?>" title="价格纪录">价格纪录</a>
