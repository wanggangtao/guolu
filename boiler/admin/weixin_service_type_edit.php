...
$id=$_GET['id'];
$service=Service_type::getInfoById($id);
?>
    ...
    <script type="text/javascript">
        $(function(){
            $("#btn_sumit").click(function () {
                ...
                $.ajax({
                    type: 'post',
                    url: 'weixin_service_type_do.php?act=edit',
                    data: {
                        id:id,
                        name:name,
                    },
...
<div id="formlist">
    ...
    <p>
        ...
        <input type="text" class="text-input input-length-30" name="name" id="name" value="<?php echo $service['name']?>"/>
