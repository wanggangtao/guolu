...
<div id="formlist">
    <p>
        ...
        <input type="text" class="text-input input-length-10" name="nominal_capacity" id="nominal_capacity" value=""/>
    </p>
    <p>
        <label style="width: 140px;">有效容积(m³)</label>
        <input type="text" class="text-input input-length-10" name="available_capacity" id="available_capacity" value=""/>
