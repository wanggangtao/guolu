        ...
        $(function(){
            $('#btn_submit').click(function () {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: 'sale_do.php?act=add_sketch',
...
<div id="formlist">
    ...
    <p>
        <label>标题</label>
        <input placeholder="*建议不超过20个字" type="text" class="text-input input-length-30" name="title" id="title" value=""  />
<!--        <span class="warn-inline" id="s_name">*建议不超过20个字 </span>-->
    </p>
    <p>
        <label>图片上传</label>
