...
$FLAG_TOPNAV	= "services_label";
$FLAG_LEFTMENU  = 'services_label_list';
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#addRule').click(function(){
                ...
                var url = 'services_label_list_add.php';
            ...
            $(".editinfo").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['500px', '600px'],
                    content: 'services_label_list_edit.php?id='+thisid
                });
            });
            ...
            $(".delete").click(function(){
                ...
                layer.confirm('确认删除该规则吗？', {
                        ...
                        $.ajax({
                            ...
                            dataType : 'json',
                            url : 'services_label_list_do.php?act=del',
...
<div id="container">
    ...
    <div id="maincontent">
        ...
        <div id="handlelist">
            ...
            $totalcount= Service_label::getCount($params);
            $shownum   = 15;
            ...
            $rows      = Service_label::getList($params);
            ?>
