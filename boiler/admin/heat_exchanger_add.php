        ...
        $(function(){
            $('#btn_sumit').click(function(){
                ...
                $.ajax({
                    ...
                    dataType :    'json',
                    url :         'heat_exchanger_do.php?act=add',
...
<div id="formlist">
    ...
    <!--<p>
        ...
        <input type="text" class="text-input input-length-10" name="first_r" id="first_r" value=""/>
        <label style="width: 140px;">二次侧进出水管径(m)</label>
        <input type="text" class="text-input input-length-10" name="second_r" id="second_r" value=""/>
    ...
    <p>
        ...
        <input type="text" class="text-input input-length-10" name="heat_surface" id="heat_surface" value=""/>
