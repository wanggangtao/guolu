        ...
        $(function(){
            ...
            $(".editinfo").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1200px', '630px'],
                    content: 'templet_edit.php?id='+thisid
                });
            });
            //详情
            $(".info").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1200px', '600px'],
                    content: 'templet_info.php?id='+thisid
                });
            });
            //删除
...
<div id="container">
    ...
    <div id="maincontent">
        <div id="position">当前位置：<a href="templet_list.php">选型方案</a> &gt;  模板管理</div>
        <div id="handlelist">
