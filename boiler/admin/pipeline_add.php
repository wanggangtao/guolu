...
<div id="formlist">
    ...
    <p>
        ...
        <input type="text" class="text-input input-length-10" name="flow_min" id="flow_min" value=""/>
        <label style="width: 140px;">流量中值(m³/h)</label>
        <input type="text" class="text-input input-length-10" name="flow_mid" id="flow_mid" value=""/>
        <label style="width: 140px;">流量最大值(m³/h)</label>
        <input type="text" class="text-input input-length-10" name="flow_max" id="flow_max" value=""/>
    </p>
    <p>
        <label style="width: 140px;">扬程最小值(m)</label>
        <input type="text" class="text-input input-length-10" name="lift_min" id="lift_min" value=""/>
        <label style="width: 140px;">扬程中值(m)</label>
        <input type="text" class="text-input input-length-10" name="lift_mid" id="lift_mid" value=""/>
        <label style="width: 140px;">扬程最大值(m)</label>
        <input type="text" class="text-input input-length-10" name="lift_max" id="lift_max" value=""/>
    </p>
    <p>
        <label style="width: 140px;">转速(r/min)</label>
        <input type="text" class="text-input input-length-10" name="speed" id="speed" value=""/>
        <label style="width: 140px;">电机功率(kW)</label>
        <input type="text" class="text-input input-length-10" name="motorpower" id="motorpower" value=""/>
        <label style="width: 140px;">必需汽蚀余量(m)</label>
        <input type="text" class="text-input input-length-10" name="npsh" id="npsh" value=""/>
    </p>
    <p>
        <label style="width: 140px;">重量(kg)</label>
        <input type="text" class="text-input input-length-10" name="weight" id="weight" value=""/>
        <label style="width: 140px;">直径</label>
