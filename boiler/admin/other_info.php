...
<div id="formlist">
    ...
    <div style="margin-top:40px;margin-left:10%">
        <textarea style="padding:5px;width:70%;height:70px;" name="content" cols=200 id="content" value="" readonly><?php echo HTMLDecode($tplcontent[0]['content']?$tplcontent[0]['content']:'');?></textarea>
    </div>
    </p>
