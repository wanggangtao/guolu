...
if(isset($_GET['id'])){
    ...
    $customer_info = weixin_customer::getInfoById($id);
}else{
    exit;
    ...
    <script type="text/javascript">
        $(function(){
            $("#btn_sumit").click(function () {
                ...
                $.ajax({
                    type: 'post',
                    url: 'weixin_customer_do.php?act=edit',
                    data: {
                        name:name,
                        id:id,
                        remark:remark
...
<div id="formlist">
    ...
    <p>
        ...
        <label><font color="#dc143c">*</font>昵称：</label>
        <input readonly type="text"  class="text-input input-length-30" name="name" id="name" style="width: 197px" value="<?php echo $customer_info['nickname']?>"/>
...
<!--        <input type="text" class="text-input input-length-30" name="name" id="name" value="--><?php //echo $miyuInfo['value']?><!--"/>-->
        <textarea cols="28" rows="3" id ="remark"></textarea>
    </p>
