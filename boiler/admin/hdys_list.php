...
//初始化
$count     = Hdys_attr::getList(1, 15, 1);
$pageSize  = 15;
$pagecount = ceil($count / $pageSize);
$page      = getPage($pagecount);
$rows      = Hdys_attr::getList($page, $pageSize, 0);
...
<head>
    ...
    <title>全自动软水器 - 辅机 - 产品管理 - 产品中心 </title>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#search').click(function(){
                ...
                location.href  = "hdys_list.php?vender="+vender+"&is_lownigtrogen="+is_lownigtrogen;
            });
            //添加
            $('#add').click(function(){
                layer.open({
            ...
            $(".editinfo").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['600px', '300px'],
                    content: 'hdys_edit.php?id='+thisid
                });
            });
            //详情
            $(".info").click(function(){
...
<div id="container">
    ...
    <div id="maincontent">
        <div id="position">当前位置：<a href="guolu_list.php">产品中心</a> &gt; 产品管理 &gt; 辅机 &gt; 全自动软水器</div>
        ...
        <div class="tablelist">
            <table>
                ...
                if(!empty($rows)){
                    foreach($rows as $row){
                        $venderInfo = Dict::getInfoById($row['hdys_vender']);
                        echo '<tr>
                                <td class="center">'.$nums.'</td>
                                <td class="center">'.$row['hdys_version'].'</td>
                                <td class="center">'.$venderInfo['name'].'</td>
                                <td class="center">'.floatval($row['hdys_outwater']).'</td>
                                <td class="center">
                                    ...
                                    <input type="hidden" id="aid" value="'.$row['hdys_id'].'"/>
