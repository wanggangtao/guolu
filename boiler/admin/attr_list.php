...
//通过level=3和parentid找出Case_attr表中的属性值。
$pid = $caseattr[0]['parentid'];
$attrs = Case_attr::getListByPidandLevel(3,$pid,0);

//固定属性值,写死不变（现在只有名称固定不变）
$fixedids = array();
if(20 == $attrid){
    $fixedids = array(20);
}elseif(23 == $attrid){
        ...
        $(function(){
            ...
            $('#add').click(function(){
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['500px', '250px'],
                    content: 'attr_add.php?pid=<?php echo $pid;?>'
                });
            });
            //修改类别
            $(".editinfo").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['500px', '250px'],
                    content: 'attr_edit.php?id='+thisid
                });
            });
            //批量删除
            $("#can").click(function(){
