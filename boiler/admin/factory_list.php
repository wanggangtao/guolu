...
$FLAG_LEFTMENU  = 'factory_list';
$FLAG_TOPNAV    = 'seletion';

//初始化,$attrid = 2 是菜单“工厂内容”
$page = 2;
$pageSize  = 15;
$totalcount     = Case_tpl::getListByAttrid($attrid = 2, $page, $pageSize, $count = 1);


$pagecount = ceil($totalcount / $pageSize);
$page      = getPage($pagecount);
$rows      = Case_tpl::getListByAttrid($attrid = 2, $page, $pageSize, $count = 0);
        ...
        $(function(){
            ...
            $(".editinfo").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['960px', '630px'],
                    content: 'factory_edit.php?id='+thisid
                });
            });
            //详情
            $(".info").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['960px', '600px'],
                    content: 'factory_detail.php?id='+thisid
                });
            });
            //删除
...
<div id="container">
    ...
    <div id="maincontent">
        <div id="position">当前位置：<a href="factory_list.php">选型方案</a> &gt; 工厂内容</div>
        <div id="handlelist">
