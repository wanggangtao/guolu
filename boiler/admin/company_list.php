...
$FLAG_LEFTMENU  = 'company_list';
$FLAG_TOPNAV    = 'seletion';

//初始化,$attrid = 1 是菜单“企业内容”
$page = 1;
$pageSize  = 15;
$totalcount     = Case_tpl::getListByAttrid($attrid = 1, $page, $pageSize, $count = 1);

$pagecount = ceil($totalcount / $pageSize);
$page      = getPage($pagecount);
$rows      = Case_tpl::getListByAttrid($attrid = 1, $page, $pageSize, $count = 0);
        ...
        $(function(){
            ...
            $(".editinfo").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1200px', '630px'],
                    content: 'company_edit.php?id='+thisid
                });
            });
            //详情
            $(".info").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['1200px', '600px'],
                    content: 'company_detail.php?id='+thisid
                });
            });
            //删除
...
<div id="container">
    ...
    <div id="maincontent">
        <div id="position">当前位置：<a href="other_list.php">选型方案</a> &gt; 企业内容</div>
        <div id="handlelist">
