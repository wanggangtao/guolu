...
$FLAG_LEFTMENU  = 'knowledge_category_list';
        ...
        $(function(){
            ...
            $('#addadmin').click(function(){
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['500px', '600px'],
                    content: 'knowledge_category_add.php'
                });
            });
            //修改管理员
            $(".editinfo").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['500px', '300px'],
                    content: 'knowledge_category_edit.php?id='+thisid
                });
            });
            ...
            $(".delete").click(function(){
                ...
                layer.confirm('确认删除该知识点吗？', {
                        ...
                        $.ajax({
                            ...
                            dataType : 'json',
                            url : 'knowledge_category_do.php?act=del',
...
<div id="container">
    ...
    <div id="maincontent">
        ...
        <div id="handlelist">
            ...
            //初始化
            //初始化
            $totalcount= knowledge_category::getCount();
            $shownum   = 15;
            $pagecount = ceil($totalcount / $shownum);
            $page      = getPage($pagecount);
            $rows      = knowledge_category::getPageList($page, $shownum);
            ?>
