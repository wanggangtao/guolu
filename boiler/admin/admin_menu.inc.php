<div id="leftmenu">
	<div class="menu1"><a href="admingroup.php">管理设置</a></div>
	<?php
  ...
  ?>
    <div class="menu1"><a href="version_list.php">APP版本管理</a></div>
	<?php
    $sessionAuth = explode('|', $ADMINAUTH);
    if(in_array('7001', $sessionAuth)){
		echo '<div class="menu2"><a';
		if($FLAG_LEFTMENU == 'version_list') echo ' class="active"';
		echo ' href="version_list.php">APP版本管理</a></div><div class="menuline"></div>';
	}
    ?>
</div>