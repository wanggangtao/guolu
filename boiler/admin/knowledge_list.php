        ...
        $(function(){
            ...
            $('.addAfter').click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['500px', '600px'],
                    content: 'rule_add.php?code='+code
                });
            });
            ...
            $('.findAfter').click(function(){
                ...
                location.href = "rule_list.php?before="+code;
            });
            ...
            $(".editinfo").click(function(){
                ...
                layer.open({
                    ...
                    shade: 0.3,
                    area: ['500px', '600px'],
                    content: 'knowledge_edit.php?id='+thisid
                });
            });
...
<div id="container">
    ...
    <div id="maincontent">
        ...
        <div id="handlelist">
            ...
            //初始化
            //初始化
            $totalcount= fact::getCount();
            $shownum   = 15;
            $pagecount = ceil($totalcount / $shownum);
            $page      = getPage($pagecount);
            $rows      = fact::getPageList($page, $shownum,$content);
            ?>
