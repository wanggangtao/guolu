...
<div id="formlist">
    ...
    <p  style="text-align:center;color:red;">* 不得超过10个字</p>
    <p>
        <label>图片上传</label>
        <input id="picurl1"  name="picurl1" type="hidden"  value="<?php echo $info['purl'];?>" />
    ...
    <p  style="padding-left:150px;color:red;">图片大小：270px * 120px</p>
    <p style="padding-left:150px;"><img id="val1" src="<?php echo $HTTP_PATH.$info['purl'];?>" width="270px" height="120px" alt="" /></p>
    <p>
    ...
    <p  style="text-align:center;color:red;">* 不得超过60个字</p>
    <p>
        <label></label>
