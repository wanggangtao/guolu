...
$video = weixin_video::getInfoById($id);
?>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#btn_sumit').click(function(){
                ...
                video = video.replace('../','').replace(HTTP_PATH,'');

                var img =$('#detail_placehold').attr('src')?$('#detail_placehold').attr('src'):'';
                img = img.replace('../','').replace(HTTP_PATH,'');
                ...
                $.ajax({
                    ...
                    dataType :    'json',
                    url :         'weixin_video_do.php?act=editvideo',
                    success :     function(data){
                        var code = data.code;
                        var msg  = data.msg;
                        switch(code){
...
<div id="formlist" style="overflow-x: hidden">
    <p style="margin-left:-13%;padding-left: 10%">
        ...
        <input type="text"  class="text-input input-length-30" name="weight" id="title" value="<?php echo $video['name'] ?>"/>
    </p>
