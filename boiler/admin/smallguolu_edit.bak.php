    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#btn_sumit').click(function(){
                ...
                var detail_placehold = $('.detail_place').attr('src')?$('.detail_place').attr('src'):'';
...
<div id="formlist">
    ...
    <div class="luobo_div">
        ...
        <div class="luobo_add_div">
            ...
            <div id="video_input_click" class="input_click" <?php if($displayVideoFlag){echo 'style="display: none"';}?>><img class="add_img" src="images/add_icon.png" ></div>
        </div>
    </div>
    <br/>
    <div class="tipDiv">
    ...
    <div class="luobo_div">
        ...
        <div class="luobo_add_div">
            ...
            if(!empty($placehold)){ ?>
                <div id="detail_div"><img class="detail_place" src="<?php echo $placehold; ?>" /><img class="detail_del" id="del_place" src="../admin/images/dot_del.png"/></div>
    ...
    <div class="luobo_div">
        ...
        <div class="drag_div luobo_add_div">
            ...
            <div id="image_input_click" class="input_click" <?php if(!$displayImgFlag){ echo 'style="display: none"';} ?>><img class="add_img" src="images/add_icon.png"></div>
        </div>
    </div>
    <br/>
