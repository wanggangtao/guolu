...
<div id="formlist">
    ...
    <p>
        ...
        <span class="warn-inline">* </span>
        <label style="width: 100px;">是否冷凝</label>
        ...
        <span class="warn-inline">* </span>
        <label style="width: 100px;">是否低氮</label>
    ...
    <p>
        ...
        <input type="text" class="text-input input-length-10" name="ratedpower" id="ratedpower" value=""/>
        <span class="warn-inline">* </span>
        <label style="width: 200px;">额定功率下最小燃气流量(m³/h)</label>
        <input type="text" class="text-input input-length-10" name="min_flow" id="min_flow" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">额定功率下最大燃气流量(m³/h)</label>
        <input type="text" class="text-input input-length-10" name="max_flow" id="max_flow" value=""/>
    </p>
    <p>
        <label style="width: 200px;">最大负荷80℃~60℃热输出(kw)</label>
        <input type="text" class="text-input input-length-10" name="heatout_60" id="heatout_60" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">最大负荷50℃~30℃热输出(kw)</label>
        <input type="text" class="text-input input-length-10" name="heatout_30" id="heatout_30" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">热输入调节范围(kw)</label>
        <input type="text" class="text-input input-length-10" name="heatout_range" id="heatout_range" value=""/>
    </p>
    <p>
        <label style="width: 200px;">最大负荷80℃~60℃热效率(%)</label>
        <input type="text" class="text-input input-length-10" name="heateffi_80" id="heateffi_80" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">最大负荷50℃~30℃热效率(%)</label>
        <input type="text" class="text-input input-length-10" name="heateffi_50" id="heateffi_50" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">30%负荷50℃~30℃热效率(%)</label>
        <input type="text" class="text-input input-length-10" name="heateffi_30" id="heateffi_30" value=""/>
    </p>
    <p>
        <label style="width: 200px;">进水温度(℃)</label>
        <input type="text" class="text-input input-length-10" name="inwater_t" id="inwater_t" value=""/>
        <span class="warn-inline">* </span>
        <label style="width: 200px;">出水温度(℃)</label>
        <input type="text" class="text-input input-length-10" name="outwater_t" id="outwater_t" value=""/>
        <span class="warn-inline">* </span>
        <label style="width: 200px;">最低/最高系统水压(bar)</label>
        <input type="text" class="text-input input-length-10" name="syswater_pre" id="syswater_pre" value=""/>
    </p>
    <p>
        <label style="width: 200px;">供热水能力(m³/h)</label>
        <input type="text" class="text-input input-length-10" name="heat_capacity" id="heat_capacity" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">最大水流量(m³/h)</label>
        <input type="text" class="text-input input-length-10" name="hot_flow" id="hot_flow" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">烟气温度（最大负荷80℃~60℃）(℃)</label>
        <input type="text" class="text-input input-length-10" name="fluegas_80" id="fluegas_80" value=""/>
    </p>
    <p>
        <label style="width: 200px;">烟气温度（最大负荷50℃~30℃）(℃)</label>
        <input type="text" class="text-input input-length-10" name="fluegas_50" id="fluegas_50" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">CO排放(mg/m³)</label>
        <input type="text" class="text-input input-length-10" name="emission_co" id="emission_co" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">NOx排放(mg/m³)</label>
        <input type="text" class="text-input input-length-10" name="emission_nox" id="emission_nox" value=""/>
    </p>
    <p>
        <label style="width: 200px;">最大冷凝水排量(L/h)</label>
        <input type="text" class="text-input input-length-10" name="condensed_max" id="condensed_max" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">冷凝水PH值</label>
        <input type="text" class="text-input input-length-10" name="condensed_ph" id="condensed_ph" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">烟道接口φ(mm)</label>
        <input type="text" class="text-input input-length-10" name="flue_interface" id="flue_interface" value=""/>
        <span class="warn-inline">* </span>
    </p>
    <p>
        <label style="width: 200px;">燃气接口</label>
        <input type="text" class="text-input input-length-10" name="gas_interface" id="gas_interface" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">进出水接口(DN)</label>
        <input type="text" class="text-input input-length-10" name="iowater_interface" id="iowater_interface" value=""/>
        <span class="warn-inline">* </span>
        <label style="width: 200px;">锅炉水容量(L)</label>
        <input type="text" class="text-input input-length-10" name="water" id="water" value=""/>
    </p>
    <p>
        <label style="width: 200px;">燃气类型</label>
        <input type="text" class="text-input input-length-10" name="gas_type" id="gas_type" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">额定燃气压力(动压)Pa</label>
        <input type="text" class="text-input input-length-10" name="gas_press" id="gas_press" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">燃气工作压力范围(动压)Pa</label>
        <input type="text" class="text-input input-length-10" name="gaspre_range" id="gaspre_range" value=""/>
    </p>
    <p>
        <label style="width: 200px;">能效等级</label>
        <input type="text" class="text-input input-length-10" name="energy_level" id="energy_level" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">锅炉长度(mm)</label>
        <input type="text" class="text-input input-length-10" name="length" id="length" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">锅炉宽度(mm)</label>
        <input type="text" class="text-input input-length-10" name="width" id="width" value=""/>
    </p>
    <p>
        <label style="width: 200px;">高度（含脚和烟囱连接）(mm)</label>
        <input type="text" class="text-input input-length-10" name="height" id="height" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">重量（净）(kg)</label>
        <input type="text" class="text-input input-length-10" name="net_weight" id="net_weight" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">参考供热面积(㎡)</label>
        <input type="text" class="text-input input-length-10" name="refer_heatarea" id="refer_heatarea" value=""/>
    </p>
    <p>
        <label style="width: 200px;">电源(V/Hz)</label>
        <input type="text" class="text-input input-length-10" name="power_supply" id="power_supply" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">噪音(dB)</label>
        <input type="text" class="text-input input-length-10" name="noise" id="noise" value=""/>
        <span class="warn-inline">&nbsp;</span>
        <label style="width: 200px;">最大耗电量(W)</label>
        <input type="text" class="text-input input-length-10" name="electric_power" id="electric_power" value=""/>
    </p>
    <!--    <p style="display: none">-->
    <!--        <label style="width: 200px;">价格(元)</label>-->
    <!--        <input type="text" class="text-input input-length-10" name="price" id="price" value="0"/>-->
    <!--    </p>-->
    <p style="display: none">
    ...
    <p>
        ...
        <div style="margin-top:40px;margin-left:10%">
            ...
            <textarea style="padding:5px;width:70%;height:70px;" name="desc" cols=200 id="desc" value=""></textarea>
        </div>
    </p>
    <p>
