<?php
/**
 * 添加项目案例  content_projectcase_add.php
 *
 * @version       v0.01
...
$info = Web_projectcase::getInfoById($id);
if(empty($info)){
	echo '非法操作';
	die();
}
        ...
        $(function(){
            ...
            $('#btn_sumit').click(function(){
                ...
                $.ajax({
                    ...
                    dataType :    'json',
                    url :         'content_projectcase_do.php?act=caseedit',
...
<!--    <p>-->
<!--        <label>浏览次数</label>-->
<!--        <input type="text" class="text-input input-length-30" name="count" id="count"  value="--><?php //echo $info['count'];?><!--" />-->
<!--    </p>-->
<!--    <p>-->
<!--        <label>发布时间</label>-->
<!--        <input type="text" class="text-input input-length-30" name="addtime" id="addtime"  value="--><?php //echo $info['addtime']?date('Y-m-d H:i:s', $info['addtime']):'';?><!--"  readonly/>-->
<!--    </p>-->
    <p>
        <label>链接地址</label>
        <input type="text" class="text-input input-length-30" name="http" id="http"  value="<?php echo $info['http'];?>" />
    ...
    <p style="padding-left:150px;"><img id="val1" src="<?php echo $HTTP_PATH.$info['picurl'];?>" width="300px" height="200px" alt="" /></p>
    <p>
        <label>　　</label>
