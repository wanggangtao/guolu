...
$message_count = Message_info::getPageList(1, 10, 0, $USERId, 0, '',message_info::READED);
$message_list = Message_info::getPageList($page, $pageSize, 1, $USERId, 0, '',message_info::READED);
        ...
        <div class="indexTop_1">
            ...
            <a href="message_unread.php">
                <div class="indexTop_2 ">
                    ...
                    <img src="static/images/emil.png">
                    <span>站内信<?php if($message_count > 0)echo '<div class="num">'.$message_count.'</div>'; ?></span>
                </div></a>
    ...
    if($message_list){
        ?>
            ...
            <div class="manageHRWJCont_middle_left">
                <ul>
                    <a href="message_unread.php"><li > 未读</li></a>
                    <a href="message_readed.php"><li class="manage_liCheck">已读</li></a>
                </ul>
            </div>
                        ...
                        layui.use('laypage', function(){
                            ...
                            laypage.render({
                                ...
                                ,jump: function(obj, first){
                                    ...
                                    if(!first){
                                        //do something
                                        location.href  = "message_readed.php?page="+obj.curr+"&pagesize="+obj.limit;
                                    }
                                }
        ...
        <div class="manageHRWJCont_middle_middle">
            ...
            <div class="NOmessage" style="margin-left: 0px">
                ...
                <div class="NOmessage_2">暂时没有已读消息哦～</div>
            </div>
        </div>
        <div class="clear"></div>
        <?php
