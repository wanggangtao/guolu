...
//}
//$id=$user_info["id"];
//$orderList=Boiler_repair_order::getListrepair($id ,33);//使用用户的来获取维修记录
//?>
<?php
/**
 * Created by PhpStorm.
...
if(isset($_GET['id'])){
    $id = safeCheck(isset($_GET['id']));
}else{
    echo "未发现用户ID";
    exit;
}
$orderList=Boiler_repair_order::getListrepair($id ,3,33);//使用用户的来获取维修记录
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div id="app">
     <div class="coupon" style="background-color: #f6f6f6">
        <div class="coupon_tab">
            ...
            <a href="weixin_repair_completed.php?id=<?php echo $id;?>" class="active">已完工</a>
        </div>
