...
//}
//$id=$user_info["id"];
//$orderList=Boiler_repair_order::getListrepair($id ,21);//使用用户的来获取维修记录
//?>
<?php
/**
 * Created by PhpStorm.
...
$orderList=Boiler_repair_order::getListrepair($id ,2,21);//使用用户的来获取维修记录
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div id="app">
    <div class="coupon" style="background-color: #f6f6f6">
        <div class="coupon_tab">
            ...
            <a href="weixin_repair_already_accetp.php?id=<?php echo $id;?>" class="active">已接单</a>
