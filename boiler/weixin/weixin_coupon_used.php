...
$couponList = Weixin_user_coupon::getListALLInfo($user_info["id"],2,array());
...
<div id="app">
    <div class="coupon" style="background-color: #f6f6f6">
        <div class="coupon_tab">
            ...
            <a href="weixin_coupon_used.php" class="active">已使用</a>
            ...
            <a class="coupon_item">
                <div class="coupon_item_top">
                    ...
                    <div class="coupon_item_right">
                        <img src="static/images/coupon_used.png" alt="">
                    </div>
                </div>
