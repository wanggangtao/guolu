...
/**
 * table_project_five_bak.class.php 数据库表:项目第五阶段备份表
 *
 * @version       v0.01
...
class Table_project_five_bak extends Table {
    ...
    static public function add($attrs){
        ...
        $r = $mypdo->sqlinsert($mypdo->prefix.'project_five_bak', $params);
        return $r;
    }
    ...
    static public function update($id,$attrs){
        ...
        //返回结果
        $r = $mypdo->sqlupdate($mypdo->prefix.'project_five_bak', $params, $where);
        return $r;
    }

    /**
     * Table_project_five_bak::getInfoById() 根据ID获取详情
     *
     * @param Integer $id  ID
     *
     * @return
    ...
    static public function getInfoById($id){
        ...
        $sql = "select * from ".$mypdo->prefix."project_five_bak where pf_id = $id limit 1";
    ...
    /**
     * Table_project_five_bak::getInfoByProjectId() 根据项目ID获取详情
     *
    ...
    static public function getInfoByProjectId($prid){
        ...
        $sql = "select * from ".$mypdo->prefix."project_five_bak where pf_project_id = $prid limit 1";
    ...
    /**
     * Table_project_five_bak::getInfoNewRecodeByPrid() 根据项目ID获取最新详情
     *
     * @param Integer $prid  项目ID
     *
     * @return
    ...
    static public function getInfoNewRecodeByPrid($prid){
        ...
        $sql = "select * from ".$mypdo->prefix."project_five_bak where pf_project_id = $prid order by pf_addtime desc limit 1";
    ...
    /**
     * Table_project_five_bak::del() 根据ID删除数据
     *
    ...
    static public function del($id){
        ...
        return $mypdo->sqldelete($mypdo->prefix.'project_five_bak', $where);
    }

    /**
     * Table_project_five_bak::delByProjectId() 根据项目ID删除数据
     *
     * @param Integer $id  项目ID
     *
     * @return
