...
/**
 * table_project_four.class.php 数据库表:项目第四阶段表
 *
 * @version       v0.01
...
class Table_project_four extends Table {
    ...
    static public function add($attrs){
        ...
        $r = $mypdo->sqlinsert($mypdo->prefix.'project_four', $params);
        return $r;
    }
    ...
    static public function update($id,$attrs){
        ...
        //返回结果
        $r = $mypdo->sqlupdate($mypdo->prefix.'project_four', $params, $where);
        return $r;
    }

    /**
     * Table_project_four::getInfoById() 根据ID获取详情
     *
     * @param Integer $id  ID
     *
     * @return
    ...
    static public function getInfoById($id){
        ...
        $sql = "select * from ".$mypdo->prefix."project_four where pf_id = $id limit 1";
    ...
    /**
     * Table_project_four::getInfoByProjectId() 根据项目ID获取详情
     *
    ...
    static public function getInfoByProjectId($prid){
        ...
        $sql = "select * from ".$mypdo->prefix."project_four where pf_project_id = $prid limit 1";
    ...
    /**
     * Table_project_four::del() 根据ID删除数据
     *
     * @param Integer $id  项目ID
     *
     * @return
    ...
    static public function del($id){
        ...
        return $mypdo->sqldelete($mypdo->prefix.'project_four', $where);
    }

    /**
     * Table_project_four::delByProjectId() 根据项目ID删除数据
     *
     * @param Integer $id  项目ID
     *
     * @return
