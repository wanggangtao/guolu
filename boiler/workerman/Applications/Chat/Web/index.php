...
<html><head>
  ...
  <script type="text/javascript">
    ...
    function onopen()
    {
        ...
        // 登录
        var login_data = '{"type":"login","uid":<?php echo $uid?>,"client_name":"'+name.replace(/"/g, '\\"')+'","room_id":"<?php echo isset($_GET['room_id']) ? $_GET['room_id'] : -1?>"}';
    ...
    function onSubmit() {
      ...
      var to_client_name = $("#client_list option:selected").text();
        ...
        ws.send('{"type":"say","msg_id":1,"from_uid":<?php echo $uid?>,"to_client_id":"'+to_client_id+'","to_client_name":"'+to_client_name+'","content":"'+input.value.replace(/"/g, '\\"').replace(/\n/g,'\\n').replace(/\r/g, '\\r')+'"}');
        input.value = "";
        input.focus();
