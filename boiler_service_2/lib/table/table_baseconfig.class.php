...
class Table_baseconfig extends Table
{
    ...
    static public function getInfoById($id)
    {
        ...
        $sql = "select * from " . $mypdo->prefix . "master_baseconfig where baseconfig_id = $id limit 1";
    ...
    static public function getInfoByKey($key)
    {
        ...
        $sql = "select * from " . $mypdo->prefix . "master_baseconfig where baseconfig_key = $key limit 1";
    ...
    static public function getInfoByArr($keyArr)
    {
        ...
        $sql = "select * from " . $mypdo->prefix . "master_baseconfig {$where}";
    ...
    static public function add($key, $value, $name)
    {
        ...
        return $mypdo->sqlinsert($mypdo->prefix . 'master_baseconfig', $param);
    }
    ...
    static public function update($id, $update_info)
    {
        ...
        return $mypdo->sqlupdate($mypdo->prefix . 'master_baseconfig', $param, $where);
    }
    ...
    static public function getStatus(){
        ...
        $sql = "select baseconfig_value as status from ".$mypdo->prefix."master_baseconfig";
        //      print_r($sql);exit();
