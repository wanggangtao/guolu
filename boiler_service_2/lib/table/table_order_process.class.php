...
class Table_order_process extends Table {
    ...
    const OPERATION1 = 1;//客户下单预约
    const OPERATION2 = 2;//管理员已派单
    const OPERATION3 = 3;//维修师傅已接单
    const OPERATION4 = 4;//维修师傅维修完成
    const OPERATION5 = 5;//客户支付完成
    const OPERATION6 = 6;//管理员进行审核
    const OPERATION7 = 7;//客户取消订单
    const OPERATION8 = 8;//维修师傅申请重派
    const OPERATION9 = 9;//订单改派中
    const OPERATION10 = 10;//客服通过电话解决问题

    const ORDER_STATUS1 = 11;//正常待派单
    const ORDER_STATUS2 = 12;//重派单
    const ORDER_STATUS3 = 21;//待接单
    const ORDER_STATUS4 = 22;//已接单
    const ORDER_STATUS5 = 23;//待支付
    const ORDER_STATUS6 = 31;//已取消
    const ORDER_STATUS7 = 32;//待审核
    const ORDER_STATUS8 = 33;//已审核
